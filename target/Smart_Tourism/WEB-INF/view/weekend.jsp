					...
					<ul class="slides">
						<li>
							<div class="slider-info">
								<img src="${pageContext.request.contextPath}/assets/images/scenic_spots/柳州/柳州香桥岩.jpg" alt="">
							</div>
						</li>
						<li>
							<div class="slider-info">
														...
														<form>
															...
															<script>
																$("#search").click(function () {
																	...
																	spot_data=$.ajax({type:"post",dataType:"json",url:"selectByTitleOrCityWeekdend",async:false,data:{jd_search_input:jd_search_input}});
																	console.log(spot_data);

																	// for (i = 1; i < 10; i++) {
																	//     //改变景点图片
																	//     var jd_img_num = "#jd_img_" + i;
																	// alert(typeof (spot_data.responseText));
																	...
																	if (obj.title != null){
																		//改变图片
																		$("#jd_img_1").attr("src", "${pageContext.request.contextPath}/assets/images/scenic_spots/" + obj.city + "/" + obj.title + ".jpg");

																		//改变星星
																		$("#jd_stars_1").removeChild();//移除原来的星星
																		var star =  obj.stars;
																		for (var j = 1; j < star; j++) {
																			$("#jd_stars_1").append("<span class=\"glyphicon glyphicon-star\" aria-hidden=\"true\"></span>");
																		}
																		//
																		// var title = obj.title;
																		// //改变标题
																		// alert(title);
																		// $("#jd_title_1").text(title);
																		//
																		// //改变主题
																		// $("#jd_theme_1").text(obj.theme);
																		//
																		// //改变地址
																		// $("#jd_address_1").text(obj.address);
																		//
																		// //改变价格
																		// $("#jd_price_1").text("￥ "+obj.ticket_price);
																	}
																	//
																	//     //改变星星
			...
			<div class="banner-bottom-grids">
				<div class="col-md-4 weekend-grids">
					<div class="weekend-grid">
						<a href="p-single">
							<img id="jd_img_1" src="${pageContext.request.contextPath}/assets/images/scenic_spots/北海/北海海洋之窗.jpg" alt=""/>
